...
\begin{cventries}
  \cventry
    ...
    {
      \begin{cvitems}
          \item {\textbf{Driving Innovation}: Continuously evolving the capabilities of the data engineering team by introducing new technologies and paradigms to make integrated data systems faster and more reliable. E.g Migrating from legacy use of AWS Batch to ECS/Fargate, integrating more systems with Redox to connect directly to our EHR, enhancing CI/CD pipelines with GitHub Actions, and improving developer workflows with Docker.}
